...
public class RedisUtils {
     ...
     * @return 值
     */
    public Object hget(String key, String item, Boolean isDelte) {
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> hmget(String key, Boolean isDelte) {
     ...
     * @return
     */
    public List<Object> lGetAll(String key, Boolean isDelete) {
        try {
